...
import { setMenuItemVisibilityAction } from "@/lib/menu-item-actions";

export function MenuItemVisibilityToggle({
  id,
  showOnMenu,
}: {
  id: string;
  ...
  return (
    <form action={setMenuItemVisibilityAction} className="flex items-center gap-2">
